...
<form onsubmit="saveReservations('{{ route('reserve.create') }}')" id="reserve_form" target="dummyframe">
@csrf
<div class="row mx-2">
...
<div class="row mx-2">
    <select name="route" class="col-2 mx-2" id="select_route" onchange="hideSearchResult();setTimeList(timeLists);"  >
    ...
    <input name="date" class="col-2 mx-2" type="date" id="input_date" onchange="hideSearchResult();setTimeList(timeLists);">

    
    <select name="time" class="col-2 mx-2" id="select_time" onchange="hideSearchResult();"></select>

    <div class="col-1 mx-2 btn theme-color" onclick="getBusModel('{{ route('reserve_bus') }}'); showBusModel('search_result')">Поиск</div>
</div>
...
<div class="d-none" id="search_result">
    ...
    <button type="submit" name="btn_reserve" value="reserve" class="btn theme-color invisible" id="reserve_button">Забронировать</button>
